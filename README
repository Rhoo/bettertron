...
If you don't have root access you can setup a local module installation with the following:
...
----
After that, simply run the better.pl script once. It will generate a config file called ~/.better
